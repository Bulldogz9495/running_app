...
export default class SwitchButton extends Component {
    ...
    _switchThump(direction) {
        ...
        if (this.state.activeSwitch === 1){
            ...
            this.props.handleValueChange(this.props.text2)
            Animated.timing(
                this.state.offsetX,
                    {
            ...
            this.props.handleValueChange(this.props.text1)
            Animated.timing(
                this.state.offsetX,
                    {
                        toValue: 0,
            ...
            <TouchableOpacity activeOpacity={1} onPress={ () => { this._switchThump(this.props.switchdirection || this.state.direction) } }>
                ...
                >
                    <View style={[{ flexDirection: this._switchDirection(this.props.switchdirection || this.state.direction) }]} >
                        ...
                        >
                            <Text style={[{ fontSize: 20 }, this.state.activeSwitch === 1 ? { color: this.props.activeFontColor || "#fff" } : { color: this.props.fontColor || "#b1b1b1" }  ]}>
                                { this.props.text1 || 'ON' }
                            </Text>
                        </View>
                        <View
                        ...
                        >
                            <Text style={[{ fontSize: 20 }, this.state.activeSwitch === 2 ? { color: this.props.activeFontColor || "#fff" } : { color: this.props.fontColor || "#b1b1b1" }  ]}>
