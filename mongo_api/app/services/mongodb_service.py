...
class MongoDBService:
    ...
    def setupDatabaseUrl(self):
        if ENVIRONMENT == 'local':
            ...
            db_url = f"""mongodb+srv://{quote_plus(credentials.access_key)}:{quote_plus(credentials.secret_key)}@cluster0.dku630t.mongodb.net/?authSource=%24external&authMechanism=MONGODB-AWS&retryWrites=true&w=majority&authMechanismProperties=AWS_SESSION_TOKEN:{quote_plus(credentials.token)}&appName=Cluster0"""
